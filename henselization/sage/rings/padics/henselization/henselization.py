...
class ExtensionFactory(UniqueFactory):
    ...
    def _get_isomorphic_approximation(self, polynomial):
        ...
        is not the constant coefficient of the resulting minpoly::
            ...
            Univariate Quotient Polynomial Ring in xbar over Number Field in a with defining polynomial a^12 - 4*a^11 + 2*a^10 + 13*a^8 - 16*a^7 - 36*a^6 + 168*a^5 - 209*a^4 + 52*a^3 + 26*a^2 + 8*a - 13 with modulus x^8 + (a^4 + 2*a^2 + 1)*x^4 + (a^9 + a^8 + 2*a^7 + 2*a^6 + 2*a^4 + 2*a^3 - 2*a^2 - a - 1/3)*x^2 + (4*a^5 + 8*a^2 + 4*a + 8)*x + a^11 + a^10 + a^8 + 2*a^5 - a^4 - a^3 - 3*a^2 + 2*a - 7
